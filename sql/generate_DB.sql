...
CREATE TABLE public.region(
                              id int NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                              country_id int not null REFERENCES public.country (id) ON UPDATE CASCADE ON DELETE SET NULL,
                              "name" varchar(128) NOT NULL
);
...
CREATE TABLE public.users(
                       ...
                       city_id int not null REFERENCES public.city (id) ON UPDATE CASCADE ON DELETE SET NULL
);
------------------------------------------------------------------------------------------------------------------------
-- Споты
...
CREATE TABLE public.spots(
                             ...
                             moder_id int DEFAULT NULL REFERENCES public.users (id)
                                 ON UPDATE CASCADE ON DELETE SET NULL,
                             city_id int not null REFERENCES public.city (id)
                                 ON UPDATE CASCADE ON DELETE SET NULL
