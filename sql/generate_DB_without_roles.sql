...
------------------------------------------------------------------------------------------------------------------------
-- 3) Тип помещения как пространства для катания (справочник)
...
CREATE TABLE public.users(
                       ...
                       city_id int not null REFERENCES public.cities (id) ON UPDATE CASCADE ON DELETE SET NULL
);
------------------------------------------------------------------------------------------------------------------------
-- 8) Споты
...
------------------------------------------------------------------------------------------------------------------------
-- 9) Информация об изображениях (спотов, пользователей, )
...
------------------------------------------------------------------------------------------------------------------------
-- 11) Промежуточная таблица спот-пользователь
...
------------------------------------------------------------------------------------------------------------------------
-- 12) Промежуточная таблица спот-вид_спота
...
------------------------------------------------------------------------------------------------------------------------
-- 13) Промежуточная таблица спот-вид_спорта
